...
class Model(object):
    ...
    def evaluate(self, test_df):
        ...
        for cls in tqdm.tqdm(self.classes):
            real = test_df.loc[test_df["class"] == cls, "predict"].values.tolist()
            predict = test_df.loc[test_df["predict"] == cls, "predict"].values.tolist()
            real_n = test_df.loc[test_df["class"] != cls, "predict"].values.tolist()
            predict_n = test_df.loc[test_df["predict"] != cls, "predict"].values.tolist()
            print(real, real_n)
